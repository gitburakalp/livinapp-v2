...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery) {/* harmony import */ var core_js_modules_es_array_find__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.find */ "./node_modules/core-js/modules/es.array.find.js");
...
/* harmony import */ var _ui_components_main_slide__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ui/components/main-slide */ "./src/js/ui/components/main-slide.js");
/* harmony import */ var _ui_components_main_thumbs_slide__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ui/components/main-thumbs-slide */ "./src/js/ui/components/main-thumbs-slide.js");
...
__webpack_provided_window_dot_jQuery = jquery__WEBPACK_IMPORTED_MODULE_8___default.a;
window.$ = jquery__WEBPACK_IMPORTED_MODULE_8___default.a;
var lang = jquery__WEBPACK_IMPORTED_MODULE_8___default()('html').attr('lang');
var localeLang = lang != 'en' ? lang + '-' + lang.toUpperCase() : 'en-US';
var $mainSlider = jquery__WEBPACK_IMPORTED_MODULE_8___default()('.main-slider');
var servicesURL = "https://www.rubiplatinum.com/api/v1/services?lang=".concat(localeLang);
var activeMenuItem = jquery__WEBPACK_IMPORTED_MODULE_8___default()('.main-list-item.active').data('type');
  ...
  fetch(url).then(function (response) {
    ...
    data.forEach(function (e) {
      if (e.serviceTypeName.toLowerCase() == activeMenuItem) {
        e.subTenantServices.forEach(function (el) {
          _ui_components_main_slide__WEBPACK_IMPORTED_MODULE_10__["default"].setMainSlide(el);
        });
      }
    });
    initSwiper();
...
var setMainListEvents = function setMainListEvents() {
  jquery__WEBPACK_IMPORTED_MODULE_8___default()('.main-list').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_8___default()(this).find('.main-list-link').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_8___default()('.main-list-item').removeClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_8___default()(this).parent().addClass('active');
    });
  });
};

var initSwiper = function initSwiper() {
  var ww = jquery__WEBPACK_IMPORTED_MODULE_8___default()(window).outerWidth();
  var $fixedBg = jquery__WEBPACK_IMPORTED_MODULE_8___default()('.bg');
  var swiperSpeed = 750;

  if (ww > 767.99) {
    jquery__WEBPACK_IMPORTED_MODULE_8___default()('<div class="main-thumb-slider-block"><div class="main-thumb-slider swiper-container"><div class="swiper-wrapper"></div></div></div>').insertBefore('.main-slider-block');
    $mainSlider.find('.main-slide').each(function () {
      ...
      _ui_components_main_thumbs_slide__WEBPACK_IMPORTED_MODULE_11__["default"].setMainThumbsSlide(title, swiperSpeed, description);
    });
    ...
    var mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_9__["default"]('.main-slider', {
      slidesPerView: 2.875,
      speed: swiperSpeed,
      spaceBetween: 15,
      loop: true,
      ...
      on: {
        transitionStart: function transitionStart(swiper) {
          ...
          swiper.slides.forEach(function (e) {
            if (jquery__WEBPACK_IMPORTED_MODULE_8___default()(e).attr('class').includes('swiper-slide-active')) {
              $activeSlide = jquery__WEBPACK_IMPORTED_MODULE_8___default()(e);
    ...
    var mainThumbsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_9__["default"]('.main-thumb-slider', {
      speed: swiperSpeed,
      slidesPerView: 2.875,
      spaceBetween: 15,
      loop: true,
      ...
      var config = {
        ...
        on: {
          transitionStart: function transitionStart(swiper) {
            ...
            $fixedBg.fadeTo(150, 0.5, function () {
              jquery__WEBPACK_IMPORTED_MODULE_8___default()(this).css('background-image', 'url(' + imgSource + ')');
            }).fadeTo(350, 1);
          }
        }
      };
      var mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_9__["default"]($this[0], config);
    });
  }
};

document.addEventListener('DOMContentLoaded', function () {
  var hh = jquery__WEBPACK_IMPORTED_MODULE_8___default()('header').outerHeight();
  getData(servicesURL);
  setMainListEvents();
  jquery__WEBPACK_IMPORTED_MODULE_8___default()(window).on({
    load: function load() {
...
/***/ "./src/js/ui/components/main-slide.js":
/*!********************************************!*\
  !*** ./src/js/ui/components/main-slide.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./src/js/ui/components/main-thumbs-slide.js":
/*!***************************************************!*\
  !*** ./src/js/ui/components/main-thumbs-slide.js ***!
  \***************************************************/
/*! exports provided: default */
...
function setMainThumbsSlide(title, speed, desc) {
  var thumbsSliderSlide = "\n  <div class=\"swiper-slide\">\n      <h3 class=\"title\">".concat(title, "</h3>\n\n      <div class=\"description-block\">\n          <p class=\"description\" data-swiper-parallax-opacity=\"0\" data-swiper-parallax-y=\"-300\" data-swiper-parallax-duration=\"").concat(speed, "\">").concat(desc, "</p>\n      </div>\n  </div>\n");
  $('.main-thumb-slider').find('.swiper-wrapper').append(mainSliderSlide);
}

/* harmony default export */ __webpack_exports__["default"] = (setMainThumbsSlide = {
  setMainThumbsSlide: setMainThumbsSlide
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
